...
C# source files (.cs, .resx, .Designer.cs).
App.config for configuration settings.
Resources (.png, .ico, etc.).
LICENSE.txt for compliance with the GNU GPL v3.0.

# Steps to build:

1.  Build Configuration:
The project is configured for Windows Forms App (.NET Framework).
Ensure the target framework is set to .NET Framework 4.7.2 in Visual Studio.
...
For questions or feedback, please use the **GitHub Issues** tab for this repository.  
We encourage community-driven discussion and collaboration.  
